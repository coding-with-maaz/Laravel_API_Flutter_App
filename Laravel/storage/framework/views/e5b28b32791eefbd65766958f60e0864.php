...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            <!--[if BLOCK]><![endif]--><?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos()): ?>
                                ...
                                <?php else: ?>
                                    <span class="inline-flex rounded-md">
                                        <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                            <?php echo e(__('Login')); ?>
            ...
            <div class="flex items-center px-4">
                ...
                <div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="font-medium text-sm text-gray-500"><?php echo e(__('Please login')); ?></div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
            </div>
...
<?php /**PATH C:\Users\k\Desktop\LaravelScraping\laravel_apis\laravel_api\resources\views/navigation-menu.blade.php ENDPATH**/ ?>